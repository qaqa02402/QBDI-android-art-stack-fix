...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VLDDQUYrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vlddqu 0x11(%ebx,%esi,4), %ymm0\n";
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVAPDYmr") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmovapd %ymm0, 0x20(%ebx,%esi,8)\n";
  alignas(32) uint8_t buffer[96] = {0};
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVAPDYrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmovapd 0x20(%ebx,%esi,8), %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[64];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVAPSYmr") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmovaps %ymm0, 0x20(%ebx,%esi,8)\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[64];
  ExpectedMemoryAccesses expectedPost = {{
      {targetAddr, 0, 32, QBDI::MEMORY_WRITE, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVAPSYrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmovaps 0x20(%ebx,%esi,8), %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[64];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVDDUPYrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmovddup 0x11(%ebx,%esi,4), %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVDQAYmr") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmovdqa %ymm0, 0x20(%ebx,%esi,8)\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[64];
  ExpectedMemoryAccesses expectedPost = {{
      {targetAddr, 0, 32, QBDI::MEMORY_WRITE, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVDQAYrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmovdqa 0x20(%ebx,%esi,8), %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[64];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVDQUYmr") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmovdqu %ymm0, 0x11(%ebx,%esi,4)\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPost = {{
      {targetAddr, 0, 32, QBDI::MEMORY_WRITE, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVDQUYrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmovdqu 0x11(%ebx,%esi,4), %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVNTDQAYrm") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vmovntdqa 0x20(%ebx,%esi,8), %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[64];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVNTDQYmr") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmovntdq %ymm0, 0x20(%ebx,%esi,8)\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[64];
  ExpectedMemoryAccesses expectedPost = {{
      {targetAddr, 0, 32, QBDI::MEMORY_WRITE, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVNTPDYmr") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmovntpd %ymm0, 0x20(%ebx,%esi,8)\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[64];
  ExpectedMemoryAccesses expectedPost = {{
      {targetAddr, 0, 32, QBDI::MEMORY_WRITE, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVNTPSYmr") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmovntps %ymm0, 0x20(%ebx,%esi,8)\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[64];
  ExpectedMemoryAccesses expectedPost = {{
      {targetAddr, 0, 32, QBDI::MEMORY_WRITE, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVSHDUPYrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmovshdup 0x11(%ebx,%esi,4), %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVSLDUPYrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmovsldup 0x11(%ebx,%esi,4), %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVUPDYmr") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmovupd %ymm0, 0x11(%ebx,%esi,4)\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPost = {{
      {targetAddr, 0, 32, QBDI::MEMORY_WRITE, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVUPDYrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmovupd 0x11(%ebx,%esi,4), %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVUPSYmr") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmovups %ymm0, 0x11(%ebx,%esi,4)\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPost = {{
      {targetAddr, 0, 32, QBDI::MEMORY_WRITE, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVUPSYrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmovups 0x11(%ebx,%esi,4), %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
