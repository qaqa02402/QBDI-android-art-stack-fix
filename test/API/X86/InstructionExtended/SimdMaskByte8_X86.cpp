...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-KMOVBkm") {
  if (!checkFeature("avx512dq")) {
    return;
  }
  const char source[] = "kmovb 0x11(%ebx,%esi,4), %k1\n";
  uint8_t buffer[40] = {0};
  buffer[21] = 0x2a;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-KMOVBmk") {
  if (!checkFeature("avx512dq")) {
    return;
  }
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-PINSRBrmi") {
  if (!checkFeature("sse4.1")) {
    return;
  }
  const char source[] = "pinsrb $0, 0x11(%ebx,%esi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  buffer[21] = 0x2c;
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-PEXTRBmri") {
  if (!checkFeature("sse4.1")) {
    return;
  }
  const char source[] =
      "movd %eax, %xmm0\n"
      "pextrb $0, %xmm0, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{}};
  ExpectedMemoryAccesses expectedPost = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPINSRBrmi") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vpinsrb $0, 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[40] = {0};
  buffer[21] = 0x2e;
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPEXTRBmri") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] =
      "vmovd %eax, %xmm0\n"
      "vpextrb $0, %xmm0, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{}};
  ExpectedMemoryAccesses expectedPost = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPBROADCASTBrm") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpbroadcastb 0x11(%ebx,%esi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  buffer[21] = 0x31;
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPBROADCASTBYrm") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpbroadcastb 0x11(%ebx,%esi,4), %ymm0\n";
  uint8_t buffer[40] = {0};
  buffer[21] = 0x31;
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
