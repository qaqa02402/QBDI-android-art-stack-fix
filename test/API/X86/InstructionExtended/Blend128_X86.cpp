...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-BLENDPDrmi") {
  if (!checkFeature("sse4.1")) {
    return;
  }
  const char source[] = "blendpd $0x1, 0x20(%ebx,%esi,4), %xmm0\n";
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-BLENDPSrmi") {
  if (!checkFeature("sse4.1")) {
    return;
  }
  const char source[] = "blendps $0x1, 0x20(%ebx,%esi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-BLENDVPDrm0") {
  if (!checkFeature("sse4.1")) {
    return;
  }
  const char source[] = "blendvpd %xmm0, 0x20(%ebx,%esi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-BLENDVPSrm0") {
  if (!checkFeature("sse4.1")) {
    return;
  }
  const char source[] = "blendvps %xmm0, 0x20(%ebx,%esi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-PBLENDVBrm0") {
  if (!checkFeature("sse4.1")) {
    return;
  }
  const char source[] = "pblendvb %xmm0, 0x20(%ebx,%esi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VBLENDPDrmi") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vblendpd $0x1, 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VBLENDPSrmi") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vblendps $0x1, 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VBLENDVPDrmr") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vblendvpd %xmm2, 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VBLENDVPSrmr") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vblendvps %xmm2, 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPBLENDDrmi") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpblendd $0x1, 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPBLENDVBrmr") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpblendvb %xmm2, 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPBLENDWrmi") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vpblendw $0x1, 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPERMIL2PDrm") {
  if (!checkFeature("xop")) {
    return;
  }
  const char source[] =
      "vpermil2pd $0x1, 0x11(%ebx,%esi,4), %xmm2, %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPERMIL2PSrm") {
  if (!checkFeature("xop")) {
    return;
  }
  const char source[] =
      "vpermil2ps $0x1, 0x11(%ebx,%esi,4), %xmm2, %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPERMIL2PDmr") {
  if (!checkFeature("xop")) {
    return;
  }
  const char source[] =
      "vpermil2pd $0x1, %xmm2, 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPERMIL2PSmr") {
  if (!checkFeature("xop")) {
    return;
  }
  const char source[] =
      "vpermil2ps $0x1, %xmm2, 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPERMILPDmi") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vpermilpd $0x1, 0x11(%ebx,%esi,4), %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPERMILPDrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vpermilpd 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPERMILPSmi") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vpermilps $0x1, 0x11(%ebx,%esi,4), %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPERMILPSrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vpermilps 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VINSERTF128rmi") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vinsertf128 $0x1, 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VINSERTI128rmi") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vinserti128 $0x1, 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VEXTRACTF128mri") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vextractf128 $0x1, %ymm0, 0x11(%ebx,%esi,4)\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPost = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VEXTRACTI128mri") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vextracti128 $0x1, %ymm0, 0x11(%ebx,%esi,4)\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPost = {{
      {targetAddr, 0, 16, QBDI::MEMORY_WRITE, QBDI::MEMORY_UNKNOWN_VALUE},
