...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PADDBrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "paddb 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PADDWrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "paddw 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PADDDrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "paddd 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PADDQrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "paddq 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PADDSBrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "paddsb 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PADDSWrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "paddsw 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PADDUSBrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "paddusb 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PADDUSWrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "paddusw 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PSUBBrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "psubb 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PSUBWrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "psubw 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PSUBDrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "psubd 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PSUBQrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "psubq 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PSUBSBrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "psubsb 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PSUBSWrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "psubsw 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PSUBUSBrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "psubusb 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PSUBUSWrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "psubusw 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PANDrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "pand 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PANDNrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "pandn 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PORrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "por 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PXORrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "pxor 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PCMPEQBrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "pcmpeqb 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PCMPEQWrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "pcmpeqw 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PCMPEQDrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "pcmpeqd 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PCMPGTBrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "pcmpgtb 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PCMPGTWrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "pcmpgtw 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PCMPGTDrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "pcmpgtd 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PMULLWrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "pmullw 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PMULHWrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "pmulhw 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PMADDWDrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "pmaddwd 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PUNPCKHBWrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "punpckhbw 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PUNPCKHWDrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "punpckhwd 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PUNPCKHDQrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "punpckhdq 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PSLLDrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "pslld 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PSLLQrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "psllq 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PSLLWrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "psllw 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PSRADrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "psrad 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PSRAWrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "psraw 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PSRLDrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "psrld 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PSRLQrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "psrlq 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PSRLWrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "psrlw 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PACKSSWBrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "packsswb 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PACKSSDWrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "packssdw 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PACKUSWBrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "packuswb 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PAVGBrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  if (!checkFeature("sse")) {
  ...
  const char source[] = "pavgb 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PAVGWrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  if (!checkFeature("sse")) {
  ...
  const char source[] = "pavgw 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PSADBWrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  if (!checkFeature("sse")) {
  ...
  const char source[] = "psadbw 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PMAXSWrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  if (!checkFeature("sse")) {
  ...
  const char source[] = "pmaxsw 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PMAXUBrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  if (!checkFeature("sse")) {
  ...
  const char source[] = "pmaxub 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PMINSWrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  if (!checkFeature("sse")) {
  ...
  const char source[] = "pminsw 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PMINUBrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  if (!checkFeature("sse")) {
  ...
  const char source[] = "pminub 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PMULHUWrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  if (!checkFeature("sse")) {
  ...
  const char source[] = "pmulhuw 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PMULUDQrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  ...
  const char source[] = "pmuludq 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PABSBrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  ...
  const char source[] = "pabsb 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PABSWrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  if (!checkFeature("ssse3")) {
  ...
  const char source[] = "pabsw 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PABSDrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  if (!checkFeature("ssse3")) {
  ...
  const char source[] = "pabsd 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PHADDDrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  if (!checkFeature("ssse3")) {
  ...
  const char source[] = "phaddd 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PHADDWrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  if (!checkFeature("ssse3")) {
  ...
  const char source[] = "phaddw 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PHADDSWrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  if (!checkFeature("ssse3")) {
  ...
  const char source[] = "phaddsw 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PHSUBDrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  if (!checkFeature("ssse3")) {
  ...
  const char source[] = "phsubd 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PHSUBWrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  if (!checkFeature("ssse3")) {
  ...
  const char source[] = "phsubw 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PHSUBSWrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  if (!checkFeature("ssse3")) {
  ...
  const char source[] = "phsubsw 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PMADDUBSWrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  if (!checkFeature("ssse3")) {
  ...
  const char source[] = "pmaddubsw 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PMULHRSWrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  if (!checkFeature("ssse3")) {
  ...
  const char source[] = "pmulhrsw 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PSHUFBrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  if (!checkFeature("ssse3")) {
  ...
  const char source[] = "pshufb 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PSIGNBrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  if (!checkFeature("ssse3")) {
  ...
  const char source[] = "psignb 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PSIGNWrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  if (!checkFeature("ssse3")) {
  ...
  const char source[] = "psignw 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PSIGNDrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  if (!checkFeature("ssse3")) {
  ...
  const char source[] = "psignd 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PALIGNRrmi") {
  if (!checkFeature("mmx")) {
    return;
  }
  if (!checkFeature("ssse3")) {
  ...
  const char source[] = "palignr $0x5, 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_PSHUFWmi") {
  if (!checkFeature("mmx")) {
    return;
  }
  if (!checkFeature("sse")) {
  ...
  const char source[] = "pshufw $0x5, 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_CVTPI2PDrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  if (!checkFeature("sse2")) {
  ...
  const char source[] = "cvtpi2pd 0x11(%ebx,%esi,4), %xmm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_CVTPI2PSrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  if (!checkFeature("sse")) {
  ...
  const char source[] = "cvtpi2ps 0x11(%ebx,%esi,4), %xmm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_CVTPS2PIrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  if (!checkFeature("sse")) {
  ...
  const char source[] = "cvtps2pi 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_CVTTPS2PIrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  if (!checkFeature("sse")) {
  ...
  const char source[] = "cvttps2pi 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_MOVQ64rm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "movq 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_MOVQ64mr") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] =
      "movq 0x11(%ecx,%edi,4), %mm0\nmovq %mm0, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[48] = {0};
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_MOVNTQmr") {
  if (!checkFeature("sse")) {
    return;
  }
  const char source[] =
      "movq 0x11(%ecx,%edi,4), %mm0\nmovntq %mm0, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[48] = {0};
  uint8_t srcBuffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  uint64_t *srcTarget = reinterpret_cast<uint64_t *>(&srcBuffer[21]);
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-PF2IDrm") {
  if (!checkFeature("3dnow")) {
    return;
  }
  const char source[] = "pf2id 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-PFACCrm") {
  if (!checkFeature("3dnow")) {
    return;
  }
  const char source[] = "pfacc 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-PFADDrm") {
  if (!checkFeature("3dnow")) {
    return;
  }
  const char source[] = "pfadd 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-PFCMPEQrm") {
  if (!checkFeature("3dnow")) {
    return;
  }
  const char source[] = "pfcmpeq 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-PFCMPGErm") {
  if (!checkFeature("3dnow")) {
    return;
  }
  const char source[] = "pfcmpge 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-PFCMPGTrm") {
  if (!checkFeature("3dnow")) {
    return;
  }
  const char source[] = "pfcmpgt 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-PFMAXrm") {
  if (!checkFeature("3dnow")) {
    return;
  }
  const char source[] = "pfmax 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-PFMINrm") {
  if (!checkFeature("3dnow")) {
    return;
  }
  const char source[] = "pfmin 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-PFMULrm") {
  if (!checkFeature("3dnow")) {
    return;
  }
  const char source[] = "pfmul 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-PFRCPrm") {
  if (!checkFeature("3dnow")) {
    return;
  }
  const char source[] = "pfrcp 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-PFRCPIT1rm") {
  if (!checkFeature("3dnow")) {
    return;
  }
  const char source[] = "pfrcpit1 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-PFRCPIT2rm") {
  if (!checkFeature("3dnow")) {
    return;
  }
  const char source[] = "pfrcpit2 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-PFRSQIT1rm") {
  if (!checkFeature("3dnow")) {
    return;
  }
  const char source[] = "pfrsqit1 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-PFRSQRTrm") {
  if (!checkFeature("3dnow")) {
    return;
  }
  const char source[] = "pfrsqrt 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-PFSUBrm") {
  if (!checkFeature("3dnow")) {
    return;
  }
  const char source[] = "pfsub 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-PFSUBRrm") {
  if (!checkFeature("3dnow")) {
    return;
  }
  const char source[] = "pfsubr 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-PI2FDrm") {
  if (!checkFeature("3dnow")) {
    return;
  }
  const char source[] = "pi2fd 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-PMULHRWrm") {
  if (!checkFeature("3dnow")) {
    return;
  }
  const char source[] = "pmulhrw 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-PF2IWrm") {
  if (!checkFeature("3dnowa")) {
    return;
  }
  const char source[] = "pf2iw 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-PI2FWrm") {
  if (!checkFeature("3dnowa")) {
    return;
  }
  const char source[] = "pi2fw 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-PFNACCrm") {
  if (!checkFeature("3dnowa")) {
    return;
  }
  const char source[] = "pfnacc 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-PFPNACCrm") {
  if (!checkFeature("3dnowa")) {
    return;
  }
  const char source[] = "pfpnacc 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-PSWAPDrm") {
  if (!checkFeature("3dnowa")) {
    return;
  }
  const char source[] = "pswapd 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-PAVGUSBrm") {
  if (!checkFeature("3dnowa")) {
    return;
  }
  const char source[] = "pavgusb 0x11(%ebx,%esi,4), %mm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x0102030405060708;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_MASKMOVQ") {
  if (!checkFeature("sse")) {
    return;
  }
  const char source[] =
  ...
  QBDI::GPRState *state = vm.getGPRState();
  state->eax = (QBDI::rword)&dataBuf;
  state->ecx = (QBDI::rword)&maskBuf;
  state->edi = (QBDI::rword)&buffer[0];
  vm.setGPRState(state);
  QBDI::rword retval;
  bool ran = runOnASM(&retval, source);
  CHECK(*reinterpret_cast<uint64_t *>(&buffer[0]) == 0x0102030405060708ULL);
  CHECK(ran);
  for (auto &e : expectedPost.accesses)
    CHECK(e.see);
}

TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-CMPXCHG8B") {
  if (!checkFeature("cx8")) {
    return;
  }
  const char source[] = "lock cmpxchg8b 0x11(%edi,%esi,4)\n";
  alignas(8) uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x1010101010101010ULL;
  QBDI::rword targetAddr = (QBDI::rword)target;
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 8, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
  }};
  ...
  state->edi = (QBDI::rword)&buffer[0];
  state->esi = 1;
  state->eax = 0x10101010;
  state->edx = 0x10101010;
  state->ebx = 0x05050505;
  state->ecx = 0x05050505;
  vm.setGPRState(state);
  QBDI::rword retval;
  bool ran = runOnASM(&retval, source);
  CHECK(ran);
  CHECK(*target == 0x0505050505050505ULL);
  for (auto &e : expectedPre.accesses)
    CHECK(e.see);
  for (auto &e : expectedPost.accesses)
    CHECK(e.see);
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-CMPXCHG8B_eaxebx") {
  if (!checkFeature("cx8")) {
    return;
  }
  const char source[] = "lock cmpxchg8b (%eax,%ebx,4)\n";
  alignas(8) uint8_t buffer[16] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[8]);
  uint32_t baseAddr = (uint32_t)(QBDI::rword)&buffer[0];
  *target = (0x22222222ULL << 32) | (uint64_t)baseAddr;
  QBDI::rword targetAddr = (QBDI::rword)target;
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 8, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
  }};
  ...
  state->eax = baseAddr;
  state->ebx = 2;
  state->edx = 0x22222222;
  state->ecx = 0x44444444;
  vm.setGPRState(state);
  QBDI::rword retval;
  bool ran = runOnASM(&retval, source);
  CHECK(ran);
  CHECK(*target == ((0x44444444ULL << 32) | 2ULL));
  for (auto &e : expectedPre.accesses)
    CHECK(e.see);
  for (auto &e : expectedPost.accesses)
    CHECK(e.see);
