...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-RCL8m1") {
  const char source[] = "rclb 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  buffer[21] = 0x81;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-RCL8mCL") {
  const char source[] = "rclb %cl, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  buffer[21] = 0x81;
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-RCL8mi") {
  const char source[] = "rclb $0x03, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  buffer[21] = 0x81;
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-RCR8m1") {
  const char source[] = "rcrb 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  buffer[21] = 0x81;
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-RCR8mCL") {
  const char source[] = "rcrb %cl, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  buffer[21] = 0x81;
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-RCR8mi") {
  const char source[] = "rcrb $0x03, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  buffer[21] = 0x81;
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-ROL8m1") {
  const char source[] = "rolb 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  buffer[21] = 0x81;
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-ROL8mCL") {
  const char source[] = "rolb %cl, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  buffer[21] = 0x81;
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-ROL8mi") {
  const char source[] = "rolb $0x03, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  buffer[21] = 0x81;
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-ROR8m1") {
  const char source[] = "rorb 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  buffer[21] = 0x81;
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-ROR8mCL") {
  const char source[] = "rorb %cl, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  buffer[21] = 0x81;
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-ROR8mi") {
  const char source[] = "rorb $0x03, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  buffer[21] = 0x81;
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-SAR8m1") {
  const char source[] = "sarb 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  buffer[21] = 0x80;
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-SAR8mCL") {
  const char source[] = "sarb %cl, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  buffer[21] = 0x80;
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-SAR8mi") {
  const char source[] = "sarb $0x03, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  buffer[21] = 0x80;
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-SHL8m1") {
  const char source[] = "shlb 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  buffer[21] = 0x03;
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-SHL8mCL") {
  const char source[] = "shlb %cl, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  buffer[21] = 0x03;
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-SHL8mi") {
  const char source[] = "shlb $0x03, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  buffer[21] = 0x03;
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-SHR8m1") {
  const char source[] = "shrb 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  buffer[21] = 0xf0;
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-SHR8mCL") {
  const char source[] = "shrb %cl, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  buffer[21] = 0xf0;
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-SHR8mi") {
  const char source[] = "shrb $0x03, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  buffer[21] = 0xf0;
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
