...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMADD132SSm_Int") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfmadd132ss 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[40] = {0};
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMADD213SSm_Int") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfmadd213ss 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMADD231SSm_Int") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfmadd231ss 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMSUB132SSm_Int") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfmsub132ss 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMSUB213SSm_Int") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfmsub213ss 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMSUB231SSm_Int") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfmsub231ss 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFNMADD132SSm_Int") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfnmadd132ss 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFNMADD213SSm_Int") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfnmadd213ss 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFNMADD231SSm_Int") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfnmadd231ss 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFNMSUB132SSm_Int") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfnmsub132ss 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFNMSUB213SSm_Int") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfnmsub213ss 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFNMSUB231SSm_Int") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfnmsub231ss 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMADDSS4mr") {
  if (!checkFeature("fma4")) {
    return;
  }
  const char source[] = "vfmaddss %xmm1, 0x11(%ebx,%esi,4), %xmm2, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMADDSS4rm") {
  if (!checkFeature("fma4")) {
    return;
  }
  const char source[] = "vfmaddss 0x11(%ebx,%esi,4), %xmm1, %xmm2, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMSUBSS4mr") {
  if (!checkFeature("fma4")) {
    return;
  }
  const char source[] = "vfmsubss %xmm1, 0x11(%ebx,%esi,4), %xmm2, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMSUBSS4rm") {
  if (!checkFeature("fma4")) {
    return;
  }
  const char source[] = "vfmsubss 0x11(%ebx,%esi,4), %xmm1, %xmm2, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFNMADDSS4mr") {
  if (!checkFeature("fma4")) {
    return;
  }
  const char source[] = "vfnmaddss %xmm1, 0x11(%ebx,%esi,4), %xmm2, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFNMADDSS4rm") {
  if (!checkFeature("fma4")) {
    return;
  }
  const char source[] = "vfnmaddss 0x11(%ebx,%esi,4), %xmm1, %xmm2, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFNMSUBSS4mr") {
  if (!checkFeature("fma4")) {
    return;
  }
  const char source[] = "vfnmsubss %xmm1, 0x11(%ebx,%esi,4), %xmm2, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFNMSUBSS4rm") {
  if (!checkFeature("fma4")) {
    return;
  }
  const char source[] = "vfnmsubss 0x11(%ebx,%esi,4), %xmm1, %xmm2, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
