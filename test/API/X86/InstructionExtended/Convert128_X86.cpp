...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-CVTDQ2PSrm") {
  const char source[] = "cvtdq2ps 0x20(%ebx,%esi,4), %xmm0\n";
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-CVTPD2DQrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "cvtpd2dq 0x20(%ebx,%esi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-CVTPD2PSrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "cvtpd2ps 0x20(%ebx,%esi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-CVTPS2DQrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "cvtps2dq 0x20(%ebx,%esi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-CVTTPD2DQrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "cvttpd2dq 0x20(%ebx,%esi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-CVTTPS2DQrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "cvttps2dq 0x20(%ebx,%esi,4), %xmm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_CVTPD2PIrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  if (!checkFeature("mmx")) {
  ...
  const char source[] = "cvtpd2pi 0x20(%ebx,%esi,4), %mm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MMX_CVTTPD2PIrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  if (!checkFeature("mmx")) {
  ...
  const char source[] = "cvttpd2pi 0x20(%ebx,%esi,4), %mm0\n";
  alignas(16) uint8_t buffer[80] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[48];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VCVTDQ2PDYrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vcvtdq2pd 0x11(%ebx,%esi,4), %ymm0\n";
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VCVTDQ2PSrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vcvtdq2ps 0x11(%ebx,%esi,4), %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VCVTNEEBF162PSrm") {
  if (!checkFeature("avxneconvert")) {
    return;
  }
  const char source[] = "vcvtneebf162ps 0x11(%ebx,%esi,4), %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VCVTNEEPH2PSrm") {
  if (!checkFeature("avxneconvert")) {
    return;
  }
  const char source[] = "vcvtneeph2ps 0x11(%ebx,%esi,4), %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VCVTNEOBF162PSrm") {
  if (!checkFeature("avxneconvert")) {
    return;
  }
  const char source[] = "vcvtneobf162ps 0x11(%ebx,%esi,4), %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VCVTNEOPH2PSrm") {
  if (!checkFeature("avxneconvert")) {
    return;
  }
  const char source[] = "vcvtneoph2ps 0x11(%ebx,%esi,4), %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VCVTPD2DQrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vcvtpd2dqx 0x11(%ebx,%esi,4), %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VCVTPD2PSrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vcvtpd2psx 0x11(%ebx,%esi,4), %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VCVTPH2PSYrm") {
  if (!checkFeature("f16c")) {
    return;
  }
  const char source[] = "vcvtph2ps 0x11(%ebx,%esi,4), %ymm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VCVTPS2DQrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vcvtps2dq 0x11(%ebx,%esi,4), %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VCVTPS2PDYrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vcvtps2pd 0x11(%ebx,%esi,4), %ymm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VCVTTPD2DQrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vcvttpd2dqx 0x11(%ebx,%esi,4), %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VCVTTPS2DQrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vcvttps2dq 0x11(%ebx,%esi,4), %xmm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VCVTPS2PHYmr") {
  if (!checkFeature("f16c")) {
    return;
  }
  const char source[] = "vcvtps2ph $0x1, %ymm0, 0x11(%ebx,%esi,4)\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPost = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPMOVSXBWYrm") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpmovsxbw 0x11(%ebx,%esi,4), %ymm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPMOVSXDQYrm") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpmovsxdq 0x11(%ebx,%esi,4), %ymm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPMOVSXWDYrm") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpmovsxwd 0x11(%ebx,%esi,4), %ymm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPMOVZXBWYrm") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpmovzxbw 0x11(%ebx,%esi,4), %ymm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPMOVZXDQYrm") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpmovzxdq 0x11(%ebx,%esi,4), %ymm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPMOVZXWDYrm") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpmovzxwd 0x11(%ebx,%esi,4), %ymm0\n";
  alignas(16) uint8_t buffer[48] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 16, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
