...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-BT16mi8") {
  const char source[] = "btw $0x4, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-BT16mr") {
  const char source[] = "btw %ax, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  uint16_t *target = reinterpret_cast<uint16_t *>(&buffer[21]);
  *target = 0x1030;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-BTC16mi8") {
  const char source[] = "btcw $0x4, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  uint16_t *target = reinterpret_cast<uint16_t *>(&buffer[21]);
  *target = 0x1030;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-BTC16mr") {
  const char source[] = "btcw %ax, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  uint16_t *target = reinterpret_cast<uint16_t *>(&buffer[21]);
  *target = 0x1030;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-BTR16mi8") {
  const char source[] = "btrw $0x4, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  uint16_t *target = reinterpret_cast<uint16_t *>(&buffer[21]);
  *target = 0x1030;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-BTR16mr") {
  const char source[] = "btrw %ax, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  uint16_t *target = reinterpret_cast<uint16_t *>(&buffer[21]);
  *target = 0x1030;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-BTS16mi8") {
  const char source[] = "btsw $0x4, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  uint16_t *target = reinterpret_cast<uint16_t *>(&buffer[21]);
  *target = 0x1030;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-BTS16mr") {
  const char source[] = "btsw %ax, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  uint16_t *target = reinterpret_cast<uint16_t *>(&buffer[21]);
  *target = 0x1030;
  QBDI::rword targetAddr = (QBDI::rword)target;
