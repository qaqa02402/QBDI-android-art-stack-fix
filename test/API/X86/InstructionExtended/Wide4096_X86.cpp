...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-FXRSTOR") {
  const char source[] = "fxrstor 0x20(%ebx,%esi,8)\n";
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-FXSAVE") {
  const char source[] = "fxsave 0x20(%ebx,%esi,8)\n";
  alignas(16) uint8_t buffer[560] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[64];
  ExpectedMemoryAccesses expectedPost = {{
