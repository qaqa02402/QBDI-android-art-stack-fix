...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VAESDECLASTYrm") {
  ...
  const char source[] = "vaesdeclast 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VAESDECLASTZ256rm") {
  if (!checkFeature("vaes")) {
    return;
  }
  ...
  const char source[] = "{evex} vaesdeclast 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VAESDECYrm") {
  if (!checkFeature("vaes")) {
    return;
  }
  if (!checkFeature("avx2")) {
  ...
  const char source[] = "vaesdec 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VAESDECZ256rm") {
  if (!checkFeature("vaes")) {
    return;
  }
  if (!checkFeature("avx512vl")) {
  ...
  const char source[] = "{evex} vaesdec 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VAESENCLASTYrm") {
  if (!checkFeature("vaes")) {
    return;
  }
  if (!checkFeature("avx2")) {
  ...
  const char source[] = "vaesenclast 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VAESENCLASTZ256rm") {
  if (!checkFeature("vaes")) {
    return;
  }
  if (!checkFeature("avx512vl")) {
  ...
  const char source[] = "{evex} vaesenclast 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VAESENCYrm") {
  if (!checkFeature("vaes")) {
    return;
  }
  if (!checkFeature("avx2")) {
  ...
  const char source[] = "vaesenc 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VAESENCZ256rm") {
  if (!checkFeature("vaes")) {
    return;
  }
  if (!checkFeature("avx512vl")) {
  ...
  const char source[] = "{evex} vaesenc 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VGF2P8AFFINEINVQBYrmi") {
  ...
  const char source[] =
      "vgf2p8affineinvqb $0x11, 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VGF2P8AFFINEQBYrmi") {
  if (!checkFeature("gfni")) {
    return;
  }
  if (!checkFeature("avx")) {
  ...
  const char source[] =
      "vgf2p8affineqb $0x11, 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VGF2P8MULBYrm") {
  if (!checkFeature("gfni")) {
    return;
  }
  if (!checkFeature("avx")) {
  ...
  const char source[] = "vgf2p8mulb 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPCLMULQDQYrmi") {
  if (!checkFeature("vpclmulqdq")) {
    return;
  }
  const char source[] = "vpclmulqdq $0x11, 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPCLMULQDQZ256rmi") {
  if (!checkFeature("vpclmulqdq")) {
    return;
  }
  if (!checkFeature("avx512vl")) {
  ...
  const char source[] =
      "{evex} vpclmulqdq $0x11, 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VSM4KEY4Yrm") {
  if (!checkFeature("sm4")) {
    return;
  }
  if (!checkFeature("avx")) {
  ...
  const char source[] = "vsm4key4 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VSM4RNDS4Yrm") {
  if (!checkFeature("sm4")) {
    return;
  }
  if (!checkFeature("avx")) {
  ...
  const char source[] = "vsm4rnds4 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
