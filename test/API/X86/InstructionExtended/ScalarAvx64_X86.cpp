...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VADDSDrm_Int") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vaddsd 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[48] = {0};
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VSUBSDrm_Int") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vsubsd 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x3ff0000000000000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMULSDrm_Int") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmulsd 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x3ff0000000000000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VDIVSDrm_Int") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vdivsd 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x3ff0000000000000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMAXSDrm_Int") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmaxsd 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x3ff0000000000000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMINSDrm_Int") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vminsd 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x3ff0000000000000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VCMPSDrmi_Int") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vcmpeqsd 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x3ff0000000000000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VROUNDSDmi_Int") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vroundsd $0x1, 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x3ff0000000000000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VSQRTSDm_Int") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vsqrtsd 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x3ff0000000000000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VCOMISDrm") {
  if (!checkFeature("avx")) {
    return;
  }
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VUCOMISDrm") {
  if (!checkFeature("avx")) {
    return;
  }
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VCVTSD2SIrm_Int") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vcvtsd2si 0x11(%ebx,%esi,4), %eax\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x3ff0000000000000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VCVTSD2SSrm_Int") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vcvtsd2ss 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x3ff0000000000000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VCVTTSD2SIrm_Int") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vcvttsd2si 0x11(%ebx,%esi,4), %eax\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x3ff0000000000000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VCVTDQ2PDrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vcvtdq2pd 0x11(%ebx,%esi,4), %xmm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x3ff0000000000000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VCVTPS2PDrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vcvtps2pd 0x11(%ebx,%esi,4), %xmm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x3ff0000000000000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VCVTPH2PSrm") {
  if (!checkFeature("f16c")) {
    return;
  }
  const char source[] = "vcvtph2ps 0x11(%ebx,%esi,4), %xmm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x3ff0000000000000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VCVTPS2PHmr") {
  if (!checkFeature("f16c")) {
    return;
  }
  const char source[] =
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVDDUPrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmovddup 0x11(%ebx,%esi,4), %xmm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x3ff0000000000000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVHPDrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmovhpd 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x3ff0000000000000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVHPSrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmovhps 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x3ff0000000000000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVLPDrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmovlpd 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x3ff0000000000000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVLPSrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmovlps 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x3ff0000000000000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVSDrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmovsd 0x11(%ebx,%esi,4), %xmm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x3ff0000000000000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVQI2PQIrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmovq 0x11(%ebx,%esi,4), %xmm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x3ff0000000000000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVHPDmr") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] =
      "vmovupd 0x11(%ecx,%edi,4), %xmm0\nvmovhpd %xmm0, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[48] = {0};
  uint8_t srcBuffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVHPSmr") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] =
      "vmovupd 0x11(%ecx,%edi,4), %xmm0\nvmovhps %xmm0, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[48] = {0};
  uint8_t srcBuffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  uint64_t *srcTargetLo = reinterpret_cast<uint64_t *>(&srcBuffer[21]);
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVLPDmr") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] =
      "vmovsd 0x11(%ecx,%edi,4), %xmm0\nvmovlpd %xmm0, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[48] = {0};
  uint8_t srcBuffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVLPSmr") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] =
      "vmovsd 0x11(%ecx,%edi,4), %xmm0\nvmovlps %xmm0, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[48] = {0};
  uint8_t srcBuffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  uint64_t *srcTarget = reinterpret_cast<uint64_t *>(&srcBuffer[21]);
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVSDmr") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] =
      "vmovsd 0x11(%ecx,%edi,4), %xmm0\nvmovsd %xmm0, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[48] = {0};
  uint8_t srcBuffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  uint64_t *srcTarget = reinterpret_cast<uint64_t *>(&srcBuffer[21]);
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVPQI2QImr") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] =
      "vmovsd 0x11(%ecx,%edi,4), %xmm0\nvmovq %xmm0, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[48] = {0};
  uint8_t srcBuffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  uint64_t *srcTarget = reinterpret_cast<uint64_t *>(&srcBuffer[21]);
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VBROADCASTSDYrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vbroadcastsd 0x11(%ebx,%esi,4), %ymm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x3ff0000000000000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPBROADCASTQrm") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpbroadcastq 0x11(%ebx,%esi,4), %xmm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPBROADCASTQYrm") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpbroadcastq 0x11(%ebx,%esi,4), %ymm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x000000000000000a;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPMOVSXBDYrm") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpmovsxbd 0x11(%ebx,%esi,4), %ymm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x000000000000000a;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPMOVSXBWrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vpmovsxbw 0x11(%ebx,%esi,4), %xmm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x000000000000000a;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPMOVSXDQrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vpmovsxdq 0x11(%ebx,%esi,4), %xmm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x000000000000000a;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPMOVSXWDrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vpmovsxwd 0x11(%ebx,%esi,4), %xmm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x000000000000000a;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPMOVSXWQYrm") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpmovsxwq 0x11(%ebx,%esi,4), %ymm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x000000000000000a;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPMOVZXBDYrm") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpmovzxbd 0x11(%ebx,%esi,4), %ymm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x000000000000000a;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPMOVZXBWrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vpmovzxbw 0x11(%ebx,%esi,4), %xmm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x000000000000000a;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPMOVZXDQrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vpmovzxdq 0x11(%ebx,%esi,4), %xmm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x000000000000000a;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPMOVZXWDrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vpmovzxwd 0x11(%ebx,%esi,4), %xmm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x000000000000000a;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPMOVZXWQYrm") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpmovzxwq 0x11(%ebx,%esi,4), %ymm0\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x000000000000000a;
  QBDI::rword targetAddr = (QBDI::rword)target;
