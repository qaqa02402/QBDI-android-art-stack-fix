...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-ADD_FI16m") {
  const char source[] =
      "fld1\n"
      "fiadds 0x11(%ebx,%esi,4)\n"
      "fstpl (%edx)\n";
  uint8_t buffer[40] = {0};
  double dummy = 0;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-DIV_FI16m") {
  const char source[] =
      "fld1\n"
      "fidivs 0x11(%ebx,%esi,4)\n"
      "fstpl (%edx)\n";
  uint8_t buffer[40] = {0};
  double dummy = 0;
  uint16_t *target = reinterpret_cast<uint16_t *>(&buffer[21]);
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-DIVR_FI16m") {
  const char source[] =
      "fld1\n"
      "fidivrs 0x11(%ebx,%esi,4)\n"
      "fstpl (%edx)\n";
  uint8_t buffer[40] = {0};
  double dummy = 0;
  uint16_t *target = reinterpret_cast<uint16_t *>(&buffer[21]);
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-FICOM16m") {
  const char source[] =
      "fld1\n"
      "ficoms 0x11(%ebx,%esi,4)\n"
      "fstpl (%edx)\n";
  uint8_t buffer[40] = {0};
  double dummy = 0;
  uint16_t *target = reinterpret_cast<uint16_t *>(&buffer[21]);
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-FICOMP16m") {
  const char source[] =
      "fld1\n"
      "ficomps 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  uint16_t *target = reinterpret_cast<uint16_t *>(&buffer[21]);
  *target = 0x0002;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-FLDCW16m") {
  const char source[] = "fldcw 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  uint16_t *target = reinterpret_cast<uint16_t *>(&buffer[21]);
  *target = 0x037f;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-FNSTCW16m") {
  const char source[] =
      "fninit\n"
      "fnstcw 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  uint16_t *target = reinterpret_cast<uint16_t *>(&buffer[21]);
  *target = 0x0000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-FNSTSWm") {
  const char source[] =
      "fninit\n"
      "fnstsw 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  uint16_t *target = reinterpret_cast<uint16_t *>(&buffer[21]);
  *target = 0x1234;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-ILD_F16m") {
  const char source[] =
      "filds 0x11(%ebx,%esi,4)\n"
      "fstpl (%edx)\n";
  uint8_t buffer[40] = {0};
  double dummy = 0;
  uint16_t *target = reinterpret_cast<uint16_t *>(&buffer[21]);
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-IST_F16m") {
  const char source[] =
      "fld1\n"
      "fists 0x11(%ebx,%esi,4)\n"
      "fstpl (%edx)\n";
  uint8_t buffer[40] = {0};
  double dummy = 0;
  uint16_t *target = reinterpret_cast<uint16_t *>(&buffer[21]);
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-IST_FP16m") {
  const char source[] =
      "fld1\n"
      "fistps 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  uint16_t *target = reinterpret_cast<uint16_t *>(&buffer[21]);
  *target = 0x0000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-ISTT_FP16m") {
  const char source[] =
      "fld1\n"
      "fisttps 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  uint16_t *target = reinterpret_cast<uint16_t *>(&buffer[21]);
  *target = 0x0000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MUL_FI16m") {
  const char source[] =
      "fld1\n"
      "fimuls 0x11(%ebx,%esi,4)\n"
      "fstpl (%edx)\n";
  uint8_t buffer[40] = {0};
  double dummy = 0;
  uint16_t *target = reinterpret_cast<uint16_t *>(&buffer[21]);
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-SUB_FI16m") {
  const char source[] =
      "fld1\n"
      "fisubs 0x11(%ebx,%esi,4)\n"
      "fstpl (%edx)\n";
  uint8_t buffer[40] = {0};
  double dummy = 0;
  uint16_t *target = reinterpret_cast<uint16_t *>(&buffer[21]);
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-SUBR_FI16m") {
  const char source[] =
      "fld1\n"
      "fisubrs 0x11(%ebx,%esi,4)\n"
      "fstpl (%edx)\n";
  uint8_t buffer[40] = {0};
  double dummy = 0;
  uint16_t *target = reinterpret_cast<uint16_t *>(&buffer[21]);
