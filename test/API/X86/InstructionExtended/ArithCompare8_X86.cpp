...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-CMP8mi") {
  const char source[] = "cmpb $0x05, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  buffer[21] = 0x30;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-CMP8mr") {
  const char source[] = "cmpb %al, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  buffer[21] = 0x30;
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-CMP8rm") {
  const char source[] = "cmpb 0x11(%ebx,%esi,4), %al\n";
  uint8_t buffer[40] = {0};
  buffer[21] = 0x05;
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-TEST8mi") {
  const char source[] = "testb $0x0f, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  buffer[21] = 0xf3;
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-TEST8mr") {
  const char source[] = "testb %al, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  buffer[21] = 0xf3;
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
