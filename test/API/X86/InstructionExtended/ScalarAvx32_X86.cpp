...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VADDSSrm_Int") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vaddss 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[40] = {0};
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VSUBSSrm_Int") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vsubss 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMULSSrm_Int") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmulss 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VDIVSSrm_Int") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vdivss 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMAXSSrm_Int") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmaxss 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMINSSrm_Int") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vminss 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VCMPSSrmi_Int") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vcmpltss 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VCVTSS2SDrm_Int") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vcvtss2sd 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VRCPSSm_Int") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vrcpss 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VRSQRTSSm_Int") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vrsqrtss 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VROUNDSSmi_Int") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vroundss $0x1, 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VSQRTSSm_Int") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vsqrtss 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VCVTSI2SDrm_Int") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vcvtsi2sdl 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x0000000a;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VCVTSI2SSrm_Int") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vcvtsi2ssl 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x0000000a;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VCVTSS2SIrm_Int") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vcvtss2si 0x11(%ebx,%esi,4), %eax\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VCVTTSS2SIrm_Int") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vcvttss2si 0x11(%ebx,%esi,4), %eax\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VCOMISSrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vcomiss 0x11(%ebx,%esi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VUCOMISSrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vucomiss 0x11(%ebx,%esi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVSSrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmovss 0x11(%ebx,%esi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVSSmr") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmovss %xmm0, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  QBDI::rword targetAddr = (QBDI::rword)target;
  ExpectedMemoryAccesses expectedPre = {{}};
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VEXTRACTPSmri") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vextractps $0x0, %xmm0, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  QBDI::rword targetAddr = (QBDI::rword)target;
  ExpectedMemoryAccesses expectedPre = {{}};
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VINSERTPSrmi") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vinsertps $0x1, 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVDI2PDIrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmovd 0x11(%ebx,%esi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x0000000a;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VMOVPDI2DImr") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vmovd %xmm0, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  QBDI::rword targetAddr = (QBDI::rword)target;
  ExpectedMemoryAccesses expectedPre = {{}};
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VBROADCASTSSrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vbroadcastss 0x11(%ebx,%esi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VBROADCASTSSYrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vbroadcastss 0x11(%ebx,%esi,4), %ymm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPBROADCASTDrm") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpbroadcastd 0x11(%ebx,%esi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPBROADCASTDYrm") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpbroadcastd 0x11(%ebx,%esi,4), %ymm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPEXTRDmri") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vpextrd $0x1, %xmm0, 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  QBDI::rword targetAddr = (QBDI::rword)target;
  ExpectedMemoryAccesses expectedPre = {{}};
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPINSRDrmi") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vpinsrd $0x1, 0x11(%ebx,%esi,4), %xmm1, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x0000000a;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPMOVSXBDrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vpmovsxbd 0x11(%ebx,%esi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPMOVSXBQYrm") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpmovsxbq 0x11(%ebx,%esi,4), %ymm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPMOVSXWQrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vpmovsxwq 0x11(%ebx,%esi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPMOVZXBDrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vpmovzxbd 0x11(%ebx,%esi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPMOVZXBQYrm") {
  if (!checkFeature("avx2")) {
    return;
  }
  const char source[] = "vpmovzxbq 0x11(%ebx,%esi,4), %ymm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VPMOVZXWQrm") {
  if (!checkFeature("avx")) {
    return;
  }
  const char source[] = "vpmovzxwq 0x11(%ebx,%esi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
