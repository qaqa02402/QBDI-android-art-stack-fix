...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-ADD_F64m") {
  const char source[] = "fld1\nfaddl 0x11(%ebx,%esi,4)\nfstpl (%edx)\n";
  uint8_t buffer[48] = {0};
  double dummy = 0;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-SUB_F64m") {
  const char source[] = "fld1\nfsubl 0x11(%ebx,%esi,4)\nfstpl (%edx)\n";
  uint8_t buffer[48] = {0};
  double dummy = 0;
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x3ff0000000000000;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-SUBR_F64m") {
  const char source[] = "fld1\nfsubrl 0x11(%ebx,%esi,4)\nfstpl (%edx)\n";
  uint8_t buffer[48] = {0};
  double dummy = 0;
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x3ff0000000000000;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-MUL_F64m") {
  const char source[] = "fld1\nfmull 0x11(%ebx,%esi,4)\nfstpl (%edx)\n";
  uint8_t buffer[48] = {0};
  double dummy = 0;
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x3ff0000000000000;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-DIV_F64m") {
  const char source[] = "fld1\nfdivl 0x11(%ebx,%esi,4)\nfstpl (%edx)\n";
  uint8_t buffer[48] = {0};
  double dummy = 0;
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x3ff0000000000000;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-DIVR_F64m") {
  const char source[] = "fld1\nfdivrl 0x11(%ebx,%esi,4)\nfstpl (%edx)\n";
  uint8_t buffer[48] = {0};
  double dummy = 0;
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x3ff0000000000000;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-FCOM64m") {
  const char source[] = "fld1\nfcoml 0x11(%ebx,%esi,4)\nfstpl (%edx)\n";
  uint8_t buffer[48] = {0};
  double dummy = 0;
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x3ff0000000000000;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-FCOMP64m") {
  const char source[] = "fld1\nfcompl 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  *target = 0x3ff0000000000000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-ILD_F64m") {
  const char source[] = "fld1\nfildll 0x11(%ebx,%esi,4)\nfstpl (%edx)\n";
  uint8_t buffer[48] = {0};
  double dummy = 0;
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-LD_F64m") {
  const char source[] = "fld1\nfldl 0x11(%ebx,%esi,4)\nfstpl (%edx)\n";
  uint8_t buffer[48] = {0};
  double dummy = 0;
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-IST_FP64m") {
  const char source[] = "fld1\nfistpll 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  QBDI::rword targetAddr = (QBDI::rword)target;
  ExpectedMemoryAccesses expectedPre = {{}};
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-ISTT_FP64m") {
  const char source[] = "fld1\nfisttpll 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  QBDI::rword targetAddr = (QBDI::rword)target;
  ExpectedMemoryAccesses expectedPre = {{}};
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-ST_F64m") {
  const char source[] = "fld1\nfstl 0x11(%ebx,%esi,4)\nfstpl (%edx)\n";
  uint8_t buffer[48] = {0};
  double dummy = 0;
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-ST_FP64m") {
  const char source[] = "fld1\nfstpl 0x11(%ebx,%esi,4)\n";
  uint8_t buffer[48] = {0};
  uint64_t *target = reinterpret_cast<uint64_t *>(&buffer[21]);
  QBDI::rword targetAddr = (QBDI::rword)target;
  ExpectedMemoryAccesses expectedPre = {{}};
