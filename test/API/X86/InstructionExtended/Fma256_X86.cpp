...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMADD132PDYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfmadd132pd 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMADD132PSYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfmadd132ps 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMADD213PDYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfmadd213pd 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMADD213PSYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfmadd213ps 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMADD231PDYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfmadd231pd 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMADD231PSYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfmadd231ps 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMADDPD4Ymr") {
  if (!checkFeature("fma4")) {
    return;
  }
  const char source[] = "vfmaddpd %ymm1, 0x11(%ebx,%esi,4), %ymm2, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMADDPD4Yrm") {
  if (!checkFeature("fma4")) {
    return;
  }
  const char source[] = "vfmaddpd 0x11(%ebx,%esi,4), %ymm1, %ymm2, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMADDPS4Ymr") {
  if (!checkFeature("fma4")) {
    return;
  }
  const char source[] = "vfmaddps %ymm1, 0x11(%ebx,%esi,4), %ymm2, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMADDPS4Yrm") {
  if (!checkFeature("fma4")) {
    return;
  }
  const char source[] = "vfmaddps 0x11(%ebx,%esi,4), %ymm1, %ymm2, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMADDSUB132PDYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfmaddsub132pd 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMADDSUB132PSYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfmaddsub132ps 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMADDSUB213PDYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfmaddsub213pd 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMADDSUB213PSYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfmaddsub213ps 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMADDSUB231PDYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfmaddsub231pd 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMADDSUB231PSYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfmaddsub231ps 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMADDSUBPD4Ymr") {
  if (!checkFeature("fma4")) {
    return;
  }
  const char source[] = "vfmaddsubpd %ymm1, 0x11(%ebx,%esi,4), %ymm2, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMADDSUBPD4Yrm") {
  if (!checkFeature("fma4")) {
    return;
  }
  const char source[] = "vfmaddsubpd 0x11(%ebx,%esi,4), %ymm1, %ymm2, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMADDSUBPS4Ymr") {
  if (!checkFeature("fma4")) {
    return;
  }
  const char source[] = "vfmaddsubps %ymm1, 0x11(%ebx,%esi,4), %ymm2, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMADDSUBPS4Yrm") {
  if (!checkFeature("fma4")) {
    return;
  }
  const char source[] = "vfmaddsubps 0x11(%ebx,%esi,4), %ymm1, %ymm2, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMSUB132PDYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfmsub132pd 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMSUB132PSYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfmsub132ps 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMSUB213PDYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfmsub213pd 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMSUB213PSYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfmsub213ps 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMSUB231PDYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfmsub231pd 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMSUB231PSYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfmsub231ps 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMSUBADD132PDYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfmsubadd132pd 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMSUBADD132PSYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfmsubadd132ps 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMSUBADD213PDYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfmsubadd213pd 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMSUBADD213PSYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfmsubadd213ps 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMSUBADD231PDYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfmsubadd231pd 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMSUBADD231PSYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfmsubadd231ps 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMSUBADDPD4Ymr") {
  if (!checkFeature("fma4")) {
    return;
  }
  const char source[] = "vfmsubaddpd %ymm1, 0x11(%ebx,%esi,4), %ymm2, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMSUBADDPD4Yrm") {
  if (!checkFeature("fma4")) {
    return;
  }
  const char source[] = "vfmsubaddpd 0x11(%ebx,%esi,4), %ymm1, %ymm2, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMSUBADDPS4Ymr") {
  if (!checkFeature("fma4")) {
    return;
  }
  const char source[] = "vfmsubaddps %ymm1, 0x11(%ebx,%esi,4), %ymm2, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMSUBADDPS4Yrm") {
  if (!checkFeature("fma4")) {
    return;
  }
  const char source[] = "vfmsubaddps 0x11(%ebx,%esi,4), %ymm1, %ymm2, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMSUBPD4Ymr") {
  if (!checkFeature("fma4")) {
    return;
  }
  const char source[] = "vfmsubpd %ymm1, 0x11(%ebx,%esi,4), %ymm2, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMSUBPD4Yrm") {
  if (!checkFeature("fma4")) {
    return;
  }
  const char source[] = "vfmsubpd 0x11(%ebx,%esi,4), %ymm1, %ymm2, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMSUBPS4Ymr") {
  if (!checkFeature("fma4")) {
    return;
  }
  const char source[] = "vfmsubps %ymm1, 0x11(%ebx,%esi,4), %ymm2, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFMSUBPS4Yrm") {
  if (!checkFeature("fma4")) {
    return;
  }
  const char source[] = "vfmsubps 0x11(%ebx,%esi,4), %ymm1, %ymm2, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFNMADD132PDYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfnmadd132pd 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFNMADD132PSYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfnmadd132ps 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFNMADD213PDYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfnmadd213pd 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFNMADD213PSYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfnmadd213ps 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFNMADD231PDYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfnmadd231pd 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFNMADD231PSYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfnmadd231ps 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFNMADDPD4Ymr") {
  if (!checkFeature("fma4")) {
    return;
  }
  const char source[] = "vfnmaddpd %ymm1, 0x11(%ebx,%esi,4), %ymm2, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFNMADDPD4Yrm") {
  if (!checkFeature("fma4")) {
    return;
  }
  const char source[] = "vfnmaddpd 0x11(%ebx,%esi,4), %ymm1, %ymm2, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFNMADDPS4Ymr") {
  if (!checkFeature("fma4")) {
    return;
  }
  const char source[] = "vfnmaddps %ymm1, 0x11(%ebx,%esi,4), %ymm2, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFNMADDPS4Yrm") {
  if (!checkFeature("fma4")) {
    return;
  }
  const char source[] = "vfnmaddps 0x11(%ebx,%esi,4), %ymm1, %ymm2, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFNMSUB132PDYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfnmsub132pd 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFNMSUB132PSYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfnmsub132ps 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFNMSUB213PDYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfnmsub213pd 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFNMSUB213PSYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfnmsub213ps 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFNMSUB231PDYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfnmsub231pd 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFNMSUB231PSYm") {
  if (!checkFeature("fma")) {
    return;
  }
  const char source[] = "vfnmsub231ps 0x11(%ebx,%esi,4), %ymm1, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFNMSUBPD4Ymr") {
  if (!checkFeature("fma4")) {
    return;
  }
  const char source[] = "vfnmsubpd %ymm1, 0x11(%ebx,%esi,4), %ymm2, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFNMSUBPD4Yrm") {
  if (!checkFeature("fma4")) {
    return;
  }
  const char source[] = "vfnmsubpd 0x11(%ebx,%esi,4), %ymm1, %ymm2, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFNMSUBPS4Ymr") {
  if (!checkFeature("fma4")) {
    return;
  }
  const char source[] = "vfnmsubps %ymm1, 0x11(%ebx,%esi,4), %ymm2, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86-VFNMSUBPS4Yrm") {
  if (!checkFeature("fma4")) {
    return;
  }
  const char source[] = "vfnmsubps 0x11(%ebx,%esi,4), %ymm1, %ymm2, %ymm0\n";
  alignas(32) uint8_t buffer[96] = {0};
  QBDI::rword targetAddr = (QBDI::rword)&buffer[21];
  ExpectedMemoryAccesses expectedPre = {{
      {targetAddr, 0, 32, QBDI::MEMORY_READ, QBDI::MEMORY_UNKNOWN_VALUE},
