...
void encodeAddr32LE(uint32_t addr, char *out) {
  snprintf(out, 32, "0x%02x,0x%02x,0x%02x,0x%02x", addr & 0xff,
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-MOV8ao32") {
  ...
  *target = 0x2a;
  ...
  snprintf(source, sizeof(source), ".byte 0x67,0xa0,%s\n", addrBytes);
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-MOV8o32a") {
  ...
  *target = 0;
  ...
  snprintf(source, sizeof(source), ".byte 0x67,0xa2,%s\n", addrBytes);
  ExpectedMemoryAccesses expectedPre = {{}};
  ExpectedMemoryAccesses expectedPost = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-MOV16ao32") {
  ...
  *target = 0x2a2a;
  ...
  snprintf(source, sizeof(source), ".byte 0x67,0x66,0xa1,%s\n", addrBytes);
  ExpectedMemoryAccesses expectedPre = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-MOV16o32a") {
  ...
  *target = 0;
  ...
  // address of `target`, little-endian)
  snprintf(source, sizeof(source), ".byte 0x67,0x66,0xa3,%s\n", addrBytes);
  ExpectedMemoryAccesses expectedPre = {{}};
  ExpectedMemoryAccesses expectedPost = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-MOV32ao32") {
  ...
  *target = 0x2a2a2a2a;
  ...
  snprintf(source, sizeof(source), ".byte 0x67,0xa1,%s\n", addrBytes);
  ExpectedMemoryAccesses expectedPre = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-MOV32o32a") {
  ...
  *target = 0;
  ...
  snprintf(source, sizeof(source), ".byte 0x67,0xa3,%s\n", addrBytes);
  ExpectedMemoryAccesses expectedPre = {{}};
  ExpectedMemoryAccesses expectedPost = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-MOV64ao32") {
  ...
  *target = 0x2a2a2a2a2a2a2a2a;
  ...
  snprintf(source, sizeof(source), ".byte 0x67,0x48,0xa1,%s\n", addrBytes);
  ExpectedMemoryAccesses expectedPre = {{
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-MOV64o32a") {
  ...
  *target = 0;
  ...
  // `target`, little-endian)
  snprintf(source, sizeof(source), ".byte 0x67,0x48,0xa3,%s\n", addrBytes);
  ExpectedMemoryAccesses expectedPre = {{}};
  ExpectedMemoryAccesses expectedPost = {{
