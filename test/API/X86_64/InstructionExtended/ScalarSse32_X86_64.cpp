...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-ADDSSrm_Int") {
  if (!checkFeature("sse")) {
    return;
  }
  const char source[] = "addss 0x11(%rbx,%rsi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-SUBSSrm_Int") {
  if (!checkFeature("sse")) {
    return;
  }
  const char source[] = "subss 0x11(%rbx,%rsi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-MULSSrm_Int") {
  if (!checkFeature("sse")) {
    return;
  }
  const char source[] = "mulss 0x11(%rbx,%rsi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-DIVSSrm_Int") {
  if (!checkFeature("sse")) {
    return;
  }
  const char source[] = "divss 0x11(%rbx,%rsi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-MAXSSrm_Int") {
  if (!checkFeature("sse")) {
    return;
  }
  const char source[] = "maxss 0x11(%rbx,%rsi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-MINSSrm_Int") {
  if (!checkFeature("sse")) {
    return;
  }
  const char source[] = "minss 0x11(%rbx,%rsi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-CMPSSrmi_Int") {
  if (!checkFeature("sse")) {
    return;
  }
  const char source[] = "cmpltss 0x11(%rbx,%rsi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-CVTSS2SDrm_Int") {
  if (!checkFeature("sse")) {
    return;
  }
  const char source[] = "cvtss2sd 0x11(%rbx,%rsi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-RCPSSm_Int") {
  if (!checkFeature("sse")) {
    return;
  }
  const char source[] = "rcpss 0x11(%rbx,%rsi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-RSQRTSSm_Int") {
  if (!checkFeature("sse")) {
    return;
  }
  const char source[] = "rsqrtss 0x11(%rbx,%rsi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-ROUNDSSmi_Int") {
  if (!checkFeature("sse4.1")) {
    return;
  }
  const char source[] = "roundss $0x1, 0x11(%rbx,%rsi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-SQRTSSm_Int") {
  if (!checkFeature("sse")) {
    return;
  }
  const char source[] = "sqrtss 0x11(%rbx,%rsi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-CVTSI2SDrm_Int") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "cvtsi2sdl 0x11(%rbx,%rsi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x0000000a;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-CVTSI2SSrm_Int") {
  if (!checkFeature("sse")) {
    return;
  }
  const char source[] = "cvtsi2ssl 0x11(%rbx,%rsi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x0000000a;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-CVTSS2SI64rm_Int") {
  if (!checkFeature("sse")) {
    return;
  }
  const char source[] = "cvtss2si 0x11(%rbx,%rsi,4), %rax\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
  ...
  vm.recordMemoryAccess(QBDI::MEMORY_READ_WRITE);
  vm.addMnemonicCB("CVTSS2SI64rm_Int", QBDI::PREINST, checkAccess,
                   &expectedPre);
  vm.addMnemonicCB("CVTSS2SI64rm_Int", QBDI::POSTINST, checkAccess,
                   &expectedPost);
  QBDI::GPRState *state = vm.getGPRState();
  state->rbx = (QBDI::rword)&buffer[0];
  state->rsi = 1;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-CVTSS2SIrm_Int") {
  if (!checkFeature("sse")) {
    return;
  }
  const char source[] = "cvtss2si 0x11(%rbx,%rsi,4), %eax\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-CVTTSS2SI64rm_Int") {
  if (!checkFeature("sse")) {
    return;
  }
  const char source[] = "cvttss2si 0x11(%rbx,%rsi,4), %rax\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
  ...
  vm.recordMemoryAccess(QBDI::MEMORY_READ_WRITE);
  vm.addMnemonicCB("CVTTSS2SI64rm_Int", QBDI::PREINST, checkAccess,
                   &expectedPre);
  vm.addMnemonicCB("CVTTSS2SI64rm_Int", QBDI::POSTINST, checkAccess,
                   &expectedPost);
  QBDI::GPRState *state = vm.getGPRState();
  state->rbx = (QBDI::rword)&buffer[0];
  state->rsi = 1;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-CVTTSS2SIrm_Int") {
  if (!checkFeature("sse")) {
    return;
  }
  const char source[] = "cvttss2si 0x11(%rbx,%rsi,4), %eax\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-COMISSrm") {
  if (!checkFeature("sse")) {
    return;
  }
  const char source[] = "comiss 0x11(%rbx,%rsi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-UCOMISSrm") {
  if (!checkFeature("sse")) {
    return;
  }
  const char source[] = "ucomiss 0x11(%rbx,%rsi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-MOVSSrm") {
  if (!checkFeature("sse")) {
    return;
  }
  const char source[] = "movss 0x11(%rbx,%rsi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-MOVSSmr") {
  if (!checkFeature("sse")) {
    return;
  }
  const char source[] = "movss %xmm0, 0x11(%rbx,%rsi,4)\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  QBDI::rword targetAddr = (QBDI::rword)target;
  ExpectedMemoryAccesses expectedPre = {{}};
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-EXTRACTPSmri") {
  if (!checkFeature("sse4.1")) {
    return;
  }
  const char source[] = "extractps $0x0, %xmm0, 0x11(%rbx,%rsi,4)\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  QBDI::rword targetAddr = (QBDI::rword)target;
  ExpectedMemoryAccesses expectedPre = {{}};
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-INSERTPSrmi") {
  if (!checkFeature("sse4.1")) {
    return;
  }
  const char source[] = "insertps $0x1, 0x11(%rbx,%rsi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-MOVDI2PDIrm") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "movd 0x11(%rbx,%rsi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x0000000a;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-MOVPDI2DImr") {
  if (!checkFeature("sse2")) {
    return;
  }
  const char source[] = "movd %xmm0, 0x11(%rbx,%rsi,4)\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  QBDI::rword targetAddr = (QBDI::rword)target;
  ExpectedMemoryAccesses expectedPre = {{}};
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-PEXTRDmri") {
  if (!checkFeature("sse4.1")) {
    return;
  }
  const char source[] = "pextrd $0x1, %xmm0, 0x11(%rbx,%rsi,4)\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  QBDI::rword targetAddr = (QBDI::rword)target;
  ExpectedMemoryAccesses expectedPre = {{}};
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-PINSRDrmi") {
  if (!checkFeature("sse4.1")) {
    return;
  }
  const char source[] = "pinsrd $0x1, 0x11(%rbx,%rsi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x0000000a;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-PMOVSXBDrm") {
  if (!checkFeature("sse4.1")) {
    return;
  }
  const char source[] = "pmovsxbd 0x11(%rbx,%rsi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-PMOVSXWQrm") {
  if (!checkFeature("sse4.1")) {
    return;
  }
  const char source[] = "pmovsxwq 0x11(%rbx,%rsi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-PMOVZXBDrm") {
  if (!checkFeature("sse4.1")) {
    return;
  }
  const char source[] = "pmovzxbd 0x11(%rbx,%rsi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-PMOVZXWQrm") {
  if (!checkFeature("sse4.1")) {
    return;
  }
  const char source[] = "pmovzxwq 0x11(%rbx,%rsi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-MMX_MOVD64rm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "movd 0x11(%rbx,%rsi,4), %mm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x0000000a;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-MMX_MOVD64mr") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "movd %mm0, 0x11(%rbx,%rsi,4)\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  QBDI::rword targetAddr = (QBDI::rword)target;
  ExpectedMemoryAccesses expectedPre = {{}};
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-MMX_PUNPCKLBWrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "punpcklbw 0x11(%rbx,%rsi,4), %mm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-MMX_PUNPCKLDQrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "punpckldq 0x11(%rbx,%rsi,4), %mm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-MMX_PUNPCKLWDrm") {
  if (!checkFeature("mmx")) {
    return;
  }
  const char source[] = "punpcklwd 0x11(%rbx,%rsi,4), %mm0\n";
  uint8_t buffer[40] = {0};
  uint32_t *target = reinterpret_cast<uint32_t *>(&buffer[21]);
  *target = 0x3f800000;
  QBDI::rword targetAddr = (QBDI::rword)target;
