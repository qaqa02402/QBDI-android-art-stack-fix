...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VCOMISHZrm") {
  if (!checkFeature("avx512fp16")) {
    return;
  }
  const char source[] = "vcomish 0x11(%rbx,%rsi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VUCOMISHZrm") {
  ...
  const char source[] = "vucomish 0x11(%rbx,%rsi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint16_t *target = reinterpret_cast<uint16_t *>(&buffer[21]);
  *target = 0x3c00;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VCVTSH2SI64Zrm_Int") {
  ...
  const char source[] = "vcvtsh2si 0x11(%rbx,%rsi,4), %rax\n";
  uint8_t buffer[40] = {0};
  uint16_t *target = reinterpret_cast<uint16_t *>(&buffer[21]);
  *target = 0x3c00;
  QBDI::rword targetAddr = (QBDI::rword)target;
  ...
  vm.recordMemoryAccess(QBDI::MEMORY_READ_WRITE);
  vm.addMnemonicCB("VCVTSH2SI64Zrm_Int", QBDI::PREINST, checkAccess,
                   &expectedPre);
  vm.addMnemonicCB("VCVTSH2SI64Zrm_Int", QBDI::POSTINST, checkAccess,
                   &expectedPost);
  QBDI::GPRState *state = vm.getGPRState();
  state->rbx = (QBDI::rword)&buffer[0];
  state->rsi = 1;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VCVTSH2SIZrm_Int") {
  ...
  const char source[] = "vcvtsh2si 0x11(%rbx,%rsi,4), %eax\n";
  uint8_t buffer[40] = {0};
  uint16_t *target = reinterpret_cast<uint16_t *>(&buffer[21]);
  *target = 0x3c00;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest,
                 "InstructionExtendedTest_X86_64-VCVTSH2USI64Zrm_Int") {
  if (!checkFeature("avx512fp16")) {
    return;
  }
  const char source[] = "vcvtsh2usi 0x11(%rbx,%rsi,4), %rax\n";
  uint8_t buffer[40] = {0};
  uint16_t *target = reinterpret_cast<uint16_t *>(&buffer[21]);
  *target = 0x3c00;
  QBDI::rword targetAddr = (QBDI::rword)target;
  ...
  vm.recordMemoryAccess(QBDI::MEMORY_READ_WRITE);
  vm.addMnemonicCB("VCVTSH2USI64Zrm_Int", QBDI::PREINST, checkAccess,
                   &expectedPre);
  vm.addMnemonicCB("VCVTSH2USI64Zrm_Int", QBDI::POSTINST, checkAccess,
                   &expectedPost);
  QBDI::GPRState *state = vm.getGPRState();
  state->rbx = (QBDI::rword)&buffer[0];
  state->rsi = 1;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VCVTSH2USIZrm_Int") {
  ...
  const char source[] = "vcvtsh2usi 0x11(%rbx,%rsi,4), %eax\n";
  uint8_t buffer[40] = {0};
  uint16_t *target = reinterpret_cast<uint16_t *>(&buffer[21]);
  *target = 0x3c00;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VMINMAXSHrmi_Int") {
  ...
  const char source[] = "vminmaxsh $1, 0x11(%rbx,%rsi,4), %xmm1, %xmm0\n";
  uint8_t buffer[40] = {0};
  uint16_t *target = reinterpret_cast<uint16_t *>(&buffer[21]);
  *target = 0x3c00;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VMINMAXSHrmik_Int") {
  ...
  const char source[] = "vminmaxsh $1, 0x11(%rbx,%rsi,4), %xmm1, %xmm0 {%k1}\n";
  uint8_t buffer[40] = {0};
  uint16_t *target = reinterpret_cast<uint16_t *>(&buffer[21]);
  *target = 0x3c00;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VMINMAXSHrmikz_Int") {
  ...
  const char source[] =
      "vminmaxsh $1, 0x11(%rbx,%rsi,4), %xmm1, %xmm0 {%k1} {z}\n";
  uint8_t buffer[40] = {0};
  uint16_t *target = reinterpret_cast<uint16_t *>(&buffer[21]);
  *target = 0x3c00;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VBCSTNEBF162PSrm") {
  ...
  const char source[] = "vbcstnebf162ps 0x11(%rbx,%rsi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint16_t *target = reinterpret_cast<uint16_t *>(&buffer[21]);
  *target = 0x3f80;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VBCSTNEBF162PSYrm") {
  ...
  const char source[] = "vbcstnebf162ps 0x11(%rbx,%rsi,4), %ymm0\n";
  uint8_t buffer[40] = {0};
  uint16_t *target = reinterpret_cast<uint16_t *>(&buffer[21]);
  *target = 0x3f80;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VBCSTNESH2PSrm") {
  ...
  const char source[] = "vbcstnesh2ps 0x11(%rbx,%rsi,4), %xmm0\n";
  uint8_t buffer[40] = {0};
  uint16_t *target = reinterpret_cast<uint16_t *>(&buffer[21]);
  *target = 0x3c00;
  QBDI::rword targetAddr = (QBDI::rword)target;
...
TEST_CASE_METHOD(APITest, "InstructionExtendedTest_X86_64-VBCSTNESH2PSYrm") {
  ...
  const char source[] = "vbcstnesh2ps 0x11(%rbx,%rsi,4), %ymm0\n";
  uint8_t buffer[40] = {0};
  uint16_t *target = reinterpret_cast<uint16_t *>(&buffer[21]);
  *target = 0x3c00;
  QBDI::rword targetAddr = (QBDI::rword)target;
